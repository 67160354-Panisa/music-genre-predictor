...
import pandas as pd
import joblib
import json  # <-- เพิ่มตัวนี้เข้ามาเพื่ออ่านไฟล์ json ค่ะ
...
def load_models():
    ...
    # โหลดไฟล์เรซูเม่ของ AI (เช็กชื่อไฟล์ให้ตรงกับในโฟลเดอร์ด้วยนะคะ)
...
# --- 🌟 ส่วนที่เพิ่มมาใหม่: แถบด้านข้าง (Sidebar) โชว์ข้อมูล Metadata ---
